...
```{r}
model <- keras_model_sequential() %>%
  layer_lstm(units = 64, input_shape = c(timesteps, 1),
...
Adapted from [https://blog.keras.io/a-ten-minute-introduction-to-sequence-to-sequence-learning-in-keras.html](https://blog.keras.io/a-ten-minute-introduction-to-sequence-to-sequence-learning-in-keras.html)
